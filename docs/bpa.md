...
- [x] Загрузка файлов различных форматов
- [x] Валидация файлов
- [x] Классификация документов
...
- [x] Переменные окружения вынесены
...
Этот BPA документ содержит все необходимые best practices, использованные для успешной реализации дипломного проекта "Сервис обработки загружаемых документов". 

Следуя этим рекомендациям, получилось создать:
